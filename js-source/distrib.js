...
(function() {
    ...
    d3.csv('data/all_vent_contrib.csv', function(dataCsv) {
        ...
        var clickedRevCap = false;
        var overRevCap = false;

        function drawRevCap() {
            if (clickedRevCap === false) {
                clickedRevCap = true;

                d3.select("#rev-dist")
                    .append("h3")
                    .html("Maximum Revenue Generated in A Year")
                    .append("p")
                    .html("&nbsp;")

                d3.select("#cap-dist")
                    .append("h3")
                    .html("Maximum Capital Raised in a Year")
                    .append("p")
                    .classed("small", true)
                    .html("For non-profits, the amount shown is maximum donation raised in a year.")
        ...
        d3.select("#btnRevCap").on("mouseover", function() {
          if (overRevCap === false) {
            overRevCap = true;
            d3.select("#expRevCap")
                .append("p")
                .html("Charts will appear below in a few seconds after clicking.")
          }
        })
