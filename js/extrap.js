...
(function() {
  ...
  svg = d3.select("#extrap").append("svg:svg").attr("width", w + hMargin).attr("height", h + vMargin).attr("display", "block").classed("center", true);
  ...
  group.append("text").attr("text-anchor", "middle").attr("x", 0).attr("x", "2em").attr("y", h / 2).attr("dy", ".5em").text(data.rev.lo);

  group.append("text").attr("text-anchor", "middle").attr("x", 0).attr("x", "2em").attr("y", h).attr("dy", "1em").text("Low estimate");

  group.append("text").attr("text-anchor", "middle").attr("x", w).attr("dx", "-2em").attr("y", h / 2).attr("dy", ".5em").text(data.rev.hi);

  group.append("text").attr("text-anchor", "middle").attr("x", w).attr("dx", "-2em").attr("y", h).attr("dy", "1em").text("High estimate");

  group.append("text").attr("text-anchor", "middle").attr("font-family", "roboto slab").attr("font-size", "30px").attr("font-variant", "small-caps").attr("x", w / 2).attr("y", h / 2).attr("dy", ".4em").text(data.rev.mi);
